---
title: 【转载】简易 Linux C 单文件串口通信
date: 2022-06-30 12:10:47
tags: 
    - C
    - 串口通信
    - Linux
...
> + 简易，能直接跑的Linux C单文件串口通信
> + 若需要使用其他串口，则修改 **UART_DEV**
> + 若需要将其作为函数调用，则需要创建一个子线程
> + 转载自：[https://blog.csdn.net/wabil/article/details/118610070](https://blog.csdn.net/wabil/article/details/118610070)
